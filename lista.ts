...
function isPar(numeroInteiro:number): boolean {
...
function mediaAritimetica(nota_1:number, nota_2:number, nota_3:number ) {
...
//questão 12
function contarDigitosParesImpares(numeroInteiro: number): { pares: number, impares: number } {
    let pares = 0;
    let impares = 0;
...
function calcularIdade(nascimento: number, anoAtual: number): number {
...
//questão 20
function imprimirEmQuadro(strings: string[]): void {
...
function filtrarLivrosPorAutor(livros: Livro[], autorDesejado: string): Livro[] {
...
function nomePessoaMaisVelha(pessoas: Pessoa[]): string | null {
    if (pessoas.length === 0) {
        return null; 
    }
...
function carrosAposAno(carroArray: Carro[], anoEspecifico: number): Carro[] {
